...
class ViTPatchEmbeddings(nn.Module):
    ...
    def forward(self, pixel_values, interpolate_pos_encoding: bool = False):
        ...
        if not interpolate_pos_encoding and (height % self.patch_size[0] != 0 or width % self.patch_size[1] != 0):
            raise ValueError(
...
class ViTEmbeddings(nn.Module):
    ...
    def __init__(self, config, use_mask_token=False):
        ...
        self.position_embeddings = nn.Parameter(torch.randn(1, self.max_num_patches + 1, config.hidden_size))
